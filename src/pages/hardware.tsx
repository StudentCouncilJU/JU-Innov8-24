...
,
    ...
    
    {
      ...
      "rules": [
        	"The game is one-on-one, utilizing 3-inch smiley balls. Robots start in separate halves of an 8 feet by 4 feet wooden ply arena with a 15 cm wide goal post on each side.",
	        ...
	        "If the ball goes out of the arena, it is placed in the center, and the match resumes. In case of a tie, each team takes three penalties.",
	        "Changes in rules, if any will be highlighted on the website and notified to the registered teams.",
	        "The match duration, penalties, and other specific rules are announced on the event day. Misbehavior may result in disqualification, and deliberate interference or damage leads to automatic disqualification. Organizers reserve the right to change rules, with any modifications highlighted on the website.",
          "Only DC power supply is allowed for the bots,cand violation of rules results in disqualification.",
    ...
    <>
      ...
      <div className='flex flex-col text-center justify-center gap-10 mt-6'>
        <div className='text-white text-6xl'>
          <p className='m-2' style={{fontFamily:"Shuri",letterSpacing:"5px"}}>HARDWARE</p>
        </div>
