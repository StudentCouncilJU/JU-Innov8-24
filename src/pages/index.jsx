  ...
  >
    Events
                    ...
                    <div className=' grid  md:flex justify-evenly '>
                               ...
                               <BackgroundGradient className="rounded-[22px] max-w-sm p-2 sm:p-1 bg-white bg-zinc-900">
                                <Link href='/hardware'>
                                <Image src='https://i.postimg.cc/Kvs4CrN0/HARDWARE.png' className="p-1 rounded-[22px]  transition-transform duration-300 transform hover:scale-105 cursor-pointer w-72" alt='Technical Poster' width={400} height={100}/>
                                </Link>
                                </BackgroundGradient>
                                </div>
